    ...
    >
      ...
      >
        ...
        <a
          ...
          className="flex items-center gap-1 bg-gradient-to-r from-[#FF3F8D] via-[#D764D4] to-[#AD5CFF] px-4 py-2 rounded-md font-semibold hover:opacity-90 transition whitespace-nowrap"
        >
